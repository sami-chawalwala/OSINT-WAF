# RAW-OSINT - OPEN SOURCE INTELLIGENCE & WAF Detector
...
RAW-OSINT is a powerful Open Source Intelligence with built-in WAF Detection. It collects emails, subdomains, IPs, social media accounts, GitHub repos, and more — all from publicly available sources.
...
mkdir RAW-OSINT
cd RAW-OSINT
git clone https://github.com/sami-chawalwala/RAW-OSINT.git
cd RAW-OSINT
